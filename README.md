...
|2025.05| Heuristic Methods |[**EB-Sampler**] Accelerated Sampling from Masked Diffusion Models via Entropy Bounded Unmasking (@Meta)| [[pdf]](https://arxiv.org/pdf/2505.24857) | |arXiv|
|2025.10| Heuristic Methods |[**LocalLeap**] Accelerated Sampling from Masked Diffusion Models via Entropy Bounded Unmasking (@Kuaishou)| [[pdf]](https://arxiv.org/pdf/2510.07081) | [[code]](https://github.com/friedrichor/LocalLeap)![](https://img.shields.io/github/stars/friedrichor/LocalLeap?style=social) |arXiv|
|2025.08| Heuristic Methods |[**Prophet**] Diffusion language models know the answer before decoding (@PolyUHK)| [[pdf]](https://arxiv.org/pdf/2508.19982) | [[code]](https://github.com/pixeli99/Prophet)![](https://img.shields.io/github/stars/pixeli99/Prophet?style=social) |arXiv|
|2025.06| Heuristic Methods |[**SlowFast Sampling**] Accelerating diffusion large language models with slowfast: The three golden principles (@SJTU)| [[pdf]](https://arxiv.org/pdf/2506.10848) | [[code]](https://github.com/LiangrunFlora/Slow-Fast-Sampling)![](https://img.shields.io/github/stars/LiangrunFlora/Slow-Fast-Sampling?style=social) |arXiv|
...
|2025.08| Heuristic Methods |[**RWS**] Reward-Weighted Sampling: Enhancing Non-Autoregressive Characteristics in Masked Diffusion LLMs (@KAIST)| [[pdf]](https://arxiv.org/pdf/2509.00707) | |EMNLP|
...
|2023.05| Variable Length |[**AR-Diffusion**] AR-Diffusion: Auto-Regressive Diffusion Model for Text Generation (@THU)| [[pdf]](https://arxiv.org/pdf/2305.09515) |[[code]](https://github.com/wutong4012/AR-Diffusion)![](https://img.shields.io/github/stars/wutong4012/AR-Diffusion.svg?style=social) |NeurIPS 2023|
